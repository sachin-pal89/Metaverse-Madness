  ...
  <section className={`${styles.paddings} z-10 relative`}>
    ...
    >
      <motion.div
        ...
        grafient-05 sm:p-8 p-4 rounded-[32px] border-[1px] 
        border-[#6a6a6a] relative"
      >
        <div className="feedback-gradient" />
        <div>
          <h4 className='font-bold sm:text-[32px] text-[26px] text-white
              sm:leading-[40px] leading-[36px]'>
            Sachin
          </h4>
          <p className='mt-[8px] font-normal text-white sm:text-[18px]
              text-[12px] sm:leading-[22px] leading-[16px]'>
            Founder | Metaversus
          </p>
          <p className='mt-[24px] font-normal text-white sm:text-[24px]
